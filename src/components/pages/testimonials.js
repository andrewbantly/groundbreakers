...
export function Testimonials() {
  return (
    <Box id="testimonials">
      <Heading as="h2" size="xl" textAlign="center" m={6}>Customer Stories</Heading>
      <Flex justifyContent="space-between">
        <Box flexBasis="48%" p={4} m={2}>
          ...
          <Box textAlign="center" mt={4}>
            <Text fontWeight={600} color={'gray'}>Bernadette</Text>
          </Box>
        </Box>
        ...
        <Box flexBasis="48%" p={4} m={2}>
          ...
          <Box textAlign="center" mt={4}>
            <Text fontWeight={600} color={'gray'}>Laurie</Text>
          </Box>
        </Box>
      </Flex>
    </Box>
