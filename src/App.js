 ...
 * - Routes and Route: React Router components that declare possible routes in the application. Currently, only the root path '/' is defined, which renders the Main component.
